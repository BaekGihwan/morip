	...
	<div class="writeContent">
	  ...
	  <div class="writeOption">
	    <div class="saveOptionWrapper">
		  <button type="reset" class="btn- resetBtn" id="boardWriteBtn-" style="font-size: 13px; border-radius: 20px; border: 1px solid #343a40; outline: none !important; margin: 5px; height: 40px;">다시작성</button>
	      <br> 
