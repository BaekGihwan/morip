...
<!---------------------------------------------------------------------->
				<div class="container-idFindForm-resident">
					...
					<input class="idFindFormResident" type="number" id="idCardNumber1" name="idCardNumber1" maxlength=6> -
...
// 다시작성버튼 
$('#idFindFormresetBtn').click(function(){
	$('#nameDiv').empty();
	$('#residenDiv').empty();
	$('#idCardNumber1').val('');
	$('#idCardNumber2').val('');
