...
public class MatzipController {
	...
	@RequestMapping(value="/matzip/matzipListShow",method=RequestMethod.GET)
	public String test() {
//		model.addAttribute("display", "/board/boardWriteForm.jsp");
		return "/matzip/matzipList";
	}
	
	@RequestMapping(value="/matzip/matzipList",method=RequestMethod.GET)
	@ResponseBody
	...
	@RequestMapping(value="/matzip/matzipView",method=RequestMethod.GET)
...
//		model.addAttribute("display", "/board/boardWriteForm.jsp");
	...
	@RequestMapping(value="/matzip/getMatzipView",method=RequestMethod.POST)
	@ResponseBody
	...
	@RequestMapping(value="/matzip/matzipSearch",method=RequestMethod.POST)
	   @ResponseBody
	...
	@RequestMapping(value="/matzip/getMatzipView2",method=RequestMethod.POST)
	   @ResponseBody
