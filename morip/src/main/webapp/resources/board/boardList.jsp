...
<body>
	...
	<div class="container-boardList">
		<input type="hidden" value="${memEmail }" id="email"> <input
			type="hidden" id="pg" value="${pg }">
		<div class="bordListTitle-">
			<span class="bordListTitle">커뮤니티</span>
			<!-- <button type="button" id="boardWriteBtn">글쓰기</button> -->
			<p id="boardWriteBtn">게시판 작성하기</p>
		</div>
		<table id="boardListTable" cellspacing="0" cellpadding="3"
			frame="hsides" rules="rows" height="100px;">
			<tr>
				<th width='160'>글번호</th>
				<th width='475'>제목</th>
				<th width='160'>작성자</th>
		...
		<form>
			...
			<div class="searchba" style="width: 1120px; text-align: center;">
				<select name="searchOption" id="searchOption">
					...
					placeholder="검색어를 입력하세요." value="${keyword }"> <input
					type="button" id="boardSearchBtn" value="검색">
			</div>
			<br>
		</form>
	</div>
