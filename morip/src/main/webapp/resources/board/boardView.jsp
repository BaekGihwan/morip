...
<body>
	...
	<form name="boardViewForm">
		...
		<input type="hidden" id="boardtable_seq" name="boardtable_seq"
			value="${boardtable_seq }"> <input type="hidden" id="pg"
			name="pg" value="${pg }"> <input type="hidden"
			value="${memEmail }" id="email">
	...
	<div class="view_boardOption">
		...
		<div class="view_reply">
			<div class="view_replyWrapper">
				<i class="far fa-comment-dots" style="margin-right: 10px;"></i> <span>댓글쓰기</span>
			</div>
		</div>
	</div>
	</div>
		...
		<div class="view_boardReplyInputWrapper">
			<div class="view_replyContentInputWrapper">
				<div class="reply_contentInput">
					...
					<textarea id="replyInputBox${boardtable_seq }" class="form-control"
						aria-label="With textarea" style="resize: none;"></textarea>
					<div class="reply_inputOption">
						<button type="button" id="insertBtn" class="btn btn-light"
							onclick="insertReplyBtn(${boardtable_seq})">등록</button>
					</div>
				</div>
			</div>
		</div>
